...
OMNIABASE begins there.

Instead of looking at numbers through one base only, it looks at them across multiple bases and asks:
...
It is already known that the same integer can be written in different bases.
...
This repository does not claim that standard mathematics is wrong.

It does not claim that writing numbers in many bases is, by itself, a new theory.

It does not claim that every representation is equally useful.

It does not claim that OMNIABASE is already complete.

The stricter claim is this:

representational choice is not neutral, and cross-base observation may help separate intrinsic structure from encoding artifact.
...
1. REPRESENTATIONAL_COST_HEATMAP.md


2. WHAT_THIS_HEATMAP_DOES_AND_DOES_NOT_SHOW.md


3. REPRESENTATIONAL_INVARIANCE_THEORY.md
